...
On Maven Central:
- [java-vorbis-support 1.2.1](https://search.maven.org/artifact/com.github.trilarion/java-vorbis-support/1.2.1/jar) licensed under LGPLv3+
  use in gradle as 'com.github.trilarion:java-vorbis-support:1.2.1'
